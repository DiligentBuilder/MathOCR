...
def exportCCode(c_code):
    print("Exporting the C code string to a C file...")

    print("The file will be saved as \"C_Code_File.c\" in the Output folder")

    with open("./Output/C_Code_File.c", "w") as filec:
        # Writing C code string to file
        filec.write(str(c_code))


def exportOctaveCode(octavecode):
    print("Exporting the Octave codce string to a MATLAB file...")

    print("The file will be saved as \"Octave_Code_File.m\" in the Output folder")

    with open("./Output/Octave_Code_File.m", "w") as fileoct:
        # Writing Octave code string to MATLAB file
        fileoct.write(str(octavecode))
...
def menu():
    ...
    print("5. Convert LATEX code prediction to C code and export")

    print("6. Convert LATEX code prediction to OCTAVE code and export")

    print("7. Export the direct LATEX code that is the output of the Math Image OCR")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Convert LATEX code prediction to Sympy, then convert the SymPy code to the C code.
        if userOption == '5':
            ...
            if prediction == '':
                ...
                # Convert the SymPy expression into C code
                converted_C_code = ccode(prediction_sympy)

                # Printing the Result
                print("The resulting C code is ")
                print(converted_C_code)

                # Exporting the C code
                print("Now, exporting converted C code")
                exportCCode(converted_C_code)

        # Convert LATEX code prediction to Sympy, then convert the SymPy code to the Octave code.
        if userOption == '6':
            ...
            if prediction == '':
                ...
                # Convert the SymPy expression into Octave code
                converted_Octave_code = octave_code(prediction_sympy)

                # Printing the Result
                print("The resulting OCTAVE code is ")
                print(converted_Octave_code)

                # Exporting the Octave code
                print("Now, exporting the converted Octave code")
                exportOctaveCode(converted_Octave_code)
